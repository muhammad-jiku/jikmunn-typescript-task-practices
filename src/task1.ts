...
function findingMinAndMaxValues(...arr: number[]): [number, number] {
...
const randomNumbers: number[] = [485623, 845, 956, 53, 5963, 9563];
...
const findTextColor = (
  ...
  if (clrCheck === true) {
    ...
    console.log(
      `${lowercaseColor} is lowercase because it does not passe the check`
    );
  }
};
